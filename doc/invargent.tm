...
<\body>
  ...
  <\eqnarray*>
    <tformat|<cwith|8|8|2|2|cell-valign|c>|<table|<row|<cell|<wide|\<exists\><wide|\<beta\>|\<bar\>><rsup|\<chi\>,k>.F<rsub|\<chi\>>|\<bar\>>>|<cell|=>|<cell|S<rsub|k>>>|<row|<cell|\<wedge\><rsub|i><around*|(|D<rsub|K><rsup|i>\<Rightarrow\>C<rsub|K><rsup|i>|)>>|<cell|=>|<cell|<with|mode|text|all
    such that >\<chi\><rsub|K><around*|(|\<alpha\><rsub|3><rsup|i,K>,\<alpha\><rsub|2><rsup|K>|)>\<in\>C<rsub|K><rsup|i><eq-number>>>|<row|<cell|\<exists\><wide|\<alpha\>|\<bar\>><rsup|\<chi\><rsub|K>><rsub|g>.G<rsub|\<chi\><rsub|K>>>|<cell|=>|<cell|Connected<around*|(|\<delta\>,DisjElim<around*|(|<wide|S<rsub|k><around*|(|D<rsup|i><rsub|K>\<wedge\>C<rsup|i><rsub|K>|)>\<wedge\>\<delta\><wide|=|\<dot\>>\<alpha\><rsup|i,K><rsub|3>|\<bar\>>|)>|)><eq-number>>>|<row|<cell|<with|mode|text|if>>|<cell|>|<cell|G<rsub|\<chi\><rsub|K>>\<neq\>\<top\>>>|<row|<cell|<with|mode|text|then
