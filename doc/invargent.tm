...
<\body>
  ...
  <\eqnarray*>
    <tformat|<cwith|14|14|2|2|cell-valign|c>|<cwith|15|15|3|3|cell-valign|B>|<table|<row|<cell|<wide|\<exists\><wide|\<beta\>|\<bar\>><rsup|\<chi\>,k>.F<rsub|\<chi\>>|\<bar\>>>|<cell|=>|<cell|S<rsub|k>>>|<row|<cell|D<rsub|K><rsup|\<alpha\>>\<Rightarrow\>C<rsub|K><rsup|\<alpha\>>\<in\>R<rsub|k><rsup|->S<rsub|k><around*|(|\<Phi\>|)>>|<cell|=>|<cell|<with|mode|text|all
...
<\references>
  <\collection>
    ...
    <associate|CaptureEscParams|<tuple|5|?>>
