...
<\body>
  ...
  <\eqnarray*>
    ...
    such that >\<chi\><rsub|K><around*|(|\<alpha\><rsub|3><rsup|i>,\<alpha\><rsub|2>|)>\<in\>C<rsub|K><rsup|i><eq-number>>>|<row|<cell|\<exists\><wide|\<alpha\>|\<bar\>><rsup|\<chi\><rsub|K>><rsub|g>.G<rsub|\<chi\><rsub|K>>>|<cell|=>|<cell|Connected<around*|(|\<delta\>,DisjElim<around*|(|<wide|S<rsub|k><around*|(|D<rsup|i><rsub|K>\<wedge\>C<rsup|i><rsub|K>|)>\<wedge\>\<delta\><wide|=|\<dot\>>\<alpha\><rsup|i><rsub|3>|\<bar\>>|)>|)><eq-number>>>|<row|<cell|<with|mode|text|if>>|<cell|>|<cell|G<rsub|\<chi\><rsub|K>><rprime|''>\<neq\>\<top\>>>|<row|<cell|<with|mode|text|then
